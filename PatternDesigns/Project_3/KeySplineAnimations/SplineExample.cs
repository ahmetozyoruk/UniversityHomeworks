...
using KeySplineAnimations.Iterator;
using System;
...
namespace KeySplineAnimations
{
    public partial class SplineExample : Page
    {
        ...
        private void OnSliderChanged(object sender, RoutedEventArgs e)
        {
            ...
            var collection = new KelimeListesi();
            collection.EkleElamani("1. x1 kontrol ediliyor.");
            collection.EkleElamani("2. y1 kontrol ediliyor.");
            collection.EkleElamani("3. x2 kontrol ediliyor.");
            collection.EkleElamani("4. y2 kontrol ediliyor.");
            

            Trace.WriteLine("Straight traversal:");
            ...
            collection.YonuDegistir();
            collection.GetirListeyi().Clear();

            collection.EkleElamani("1. x1 kontrol edildi.");
            collection.EkleElamani("2. y1 kontrol edildi.");
            collection.EkleElamani("3. x2 kontrol edildi.");
            collection.EkleElamani("4. y2 kontrol edildi.");
            collection.EkleElamani("5. Islem tamamlandi.");
