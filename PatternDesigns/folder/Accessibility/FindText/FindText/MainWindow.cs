...
using FindText.Abstract_Factory_Pattern;
...
namespace FindText
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void LoadFile(object sender, RoutedEventArgs args)
        {
            ...
            var openFile = client.CreateFactory(new ConcreteFactory1()).CreateDialog().openFileDialog();
        ...
        private void SaveFile(object sender, RoutedEventArgs args)
        {
            ...
            var saveFile = client.CreateFactory(new ConcreteFactory1()).CreateDialog().openFileDialog();
